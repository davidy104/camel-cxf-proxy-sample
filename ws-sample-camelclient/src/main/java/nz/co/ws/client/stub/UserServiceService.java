 ...
 * 2015-02-26T07:30:00.382+13:00
 * Generated source version: 2.7.7
 * 
 */
@WebServiceClient(name = "UserServiceService", 
                  wsdlLocation = "file:/home/david/study/project/camel-ws-proxy/ws-sample-camelclient/src/main/resources/etc/user-service.wsdl",
...
public class UserServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/david/study/project/camel-ws-proxy/ws-sample-camelclient/src/main/resources/etc/user-service.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/david/study/project/camel-ws-proxy/ws-sample-camelclient/src/main/resources/etc/user-service.wsdl");
        }
        WSDL_LOCATION = url;
    }
