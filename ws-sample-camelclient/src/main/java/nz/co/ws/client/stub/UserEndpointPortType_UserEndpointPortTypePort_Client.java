...
public final class UserEndpointPortType_UserEndpointPortTypePort_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        nz.co.ws.client.stub.CreateUserRequest _createUser_parameters = null;
        nz.co.ws.client.stub.CreateUserResponse _createUser__return = port.createUser(_createUser_parameters);
