 ...
 * 2015-02-27T08:42:50.205+13:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "UserServiceService", 
                  wsdlLocation = "file:/home/david/study/project/camel-ws-proxy/ws-sample-proxy-client/src/main/resources/etc/userws-proxy.wsdl",
...
public class UserServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/david/study/project/camel-ws-proxy/ws-sample-proxy-client/src/main/resources/etc/userws-proxy.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/david/study/project/camel-ws-proxy/ws-sample-proxy-client/src/main/resources/etc/userws-proxy.wsdl");
        }
        WSDL_LOCATION = url;
    }
