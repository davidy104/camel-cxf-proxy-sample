 ...
 * generated in the nz.co.ws.proxy.integration.stub package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: nz.co.ws.proxy.integration.stub
     * 
     */
